...
The classification in the columns below is, in many cases, inadequate. It serves only as a general guide and should not be taken as the source of truth.
...
[Allium](https://allium.moongarden.dev) | [AI Contributions](https://github.com/moongardenmods/allium/blob/main/CONTRIBUTING.md#ai-contributions) | No | - | - | - | -
[Amberol](https://gitlab.gnome.org/World/amberol) | [Use of Generative AI](https://gitlab.gnome.org/World/amberol/-/blob/main/CONTRIBUTING.md#use-of-generative-ai) | No | - | Yes | - | Use of AI to "answer questions and find information" permitted but strongly discouraged in favour of "existing documentation" and "chats and forums"
...
[Arcalibre](https://codeberg.org/rereading/arcalibre) | [rereading: because books are art, and art is labor](https://blog.rereading.space/rereading-because-books-are-art-and-art-is-labor) | No | - | - | - | -
...
[Avoyd](https://www.avoyd.com) | [What is your policy on the use of generative AI and LLMs?](https://www.enkisoftware.com/faq#nogenAI) | No | - | - | - | It is AI image denoising that uses training data with appropriate rights. It doesn't allow LLM use for writing the code.
[Bevy](https://bevy.org) | [AI Policy](https://bevy.org/learn/contribute/policies/ai/) | No | - | Yes | - | -
[Bobby](https://github.com/hbons/Bobby) | [Use of Generative AI](https://github.com/hbons/Bobby?tab=contributing-ov-file#use-of-generative-ai) | No | - | Yes | - | -
[Borgmatic](https://torsion.org/borgmatic) | [AGENTS.md](https://projects.torsion.org/borgmatic-collective/borgmatic/src/branch/main/AGENTS.md) | No* | - | - | - | An AGENTS.md file is provided, which instructs the agent to not modify the code. AI is allowed to interact with the code in a read-only manner.
...
[Cheese Paper](https://brie.gay/cheese-paper) | [AI](https://codeberg.org/ByteOfBrie/cheese-paper#ai) | No | - | Yes | - | -
[chezmoi](https://www.chezmoi.io) | [Developer guide](https://www.chezmoi.io/developer-guide/) | No | - | - | - | Shows a Claude banner due to [a single Claude commit](https://slopscan.ava.pet/repo/https%3A%2F%2Fgithub%2Ecom%2Ftwpayne%2Fchezmoi) that was created before the [introduction of the ban](https://github.com/twpayne/chezmoi/commit/7938c65ca55aaeaf6fc56d37b0b32073d2e5c461).
[Chimera Linux](https://chimera-linux.org) | [Mastodon Post](https://gts.chimera-linux.org/@chimera/statuses/01KK78VSB4G5S75STYEY3YTR2H) | No | - | - | - | -
[ChiPass](https://chipass.org) | [Contributing to KeePassChi](https://codeberg.org/ChiPass/ChiPass/src/branch/main/CONTRIBUTING.md) | No | - | - | - | -
...
[Decker](https://beyondloom.com/decker) | [Contributing](https://github.com/JohnEarnest/Decker/blob/main/Readme.md#contributing) | No | - | - | - | -
...
[Fractal](https://gitlab.gnome.org/World/fractal) | [LLM Contributions](https://gitlab.gnome.org/World/fractal/-/blob/main/CONTRIBUTING.md#llm-contributions) | No | - | Yes | - | -
[gaypanel](https://codeberg.org/pastthepixels/gaypanel) | [Things that aren't allowed](https://codeberg.org/pastthepixels/gaypanel/src/branch/main/CONTRIBUTING.md#things-that-aren-t-allowed) | No | - | - | - | -
...
[Gitte](https://codeberg.org/ckruse/Gitte) | [Contributing](https://codeberg.org/ckruse/Gitte/src/branch/main/README.md#contributing) | No | - | - | - | -
...
[Halloy](https://github.com/squidowl/halloy) | [AI](https://halloy.chat/contributing#ai) | No | - | - | - | Has the Claude banner due to [a single Claude commit](https://github.com/squidowl/halloy/commit/826dc9d5b8a513900f193bdb3ad57abc96f2adcc). There's currently at least [some effort going into removing it](https://github.com/squidowl/halloy/issues/1814)
[Highscore](https://gitlab.gnome.org/World/highscore) | [Use of Generative AI](https://gitlab.gnome.org/World/highscore/-/blob/main/CONTRIBUTING.md?ref_type=heads#use-of-generative-ai) | No | - | Yes | - | This includes its porting interface [libhighscore](https://gitlab.gnome.org/alicem/libhighscore#use-of-generative-ai)
[hit-counter.net](https://www.hit-counter.net/index.php) | [AI Policy](https://www.hit-counter.net/aipolicy.php) | No | - | - | - | -
...
[Iceshrimp](https://iceshrimp.dev/iceshrimp/iceshrimp.net) | ["AI" policy](https://kb.iceshrimp.dev/s/63ae7f15-e1f1-45d6-ae26-d3a3b35d2e02/doc/ai-policy-paZIKo68tk) | No | - | - | - | -
[Idris](https://www.idris-lang.org) | [Things We Will Not Accept](https://github.com/idris-lang/Idris2/blob/main/CONTRIBUTING.md#things-we-will-not-accept) | No | - | - | - | Has the Claude banner due to [a single Claude commit](https://github.com/idris-lang/Idris2/commit/d83bc7d7964bd99ea16f8888b7cb9143a1343846) that occurred before this policy took effect. After that commit was made, [the project changed their contributing guidelines](https://github.com/idris-lang/Idris2/pull/3755) to block LLM code.
[Inkscape](https://inkscape.org) | [Mastodon Post](https://social.treehouse.systems/@dysfun/116182391411729473) | No | - | Yes | - | The full LLM policy is being actively developed but [appears to lean towards banning generative AI](https://gitlab.com/inkscape/inkscape-board/-/work_items/5#note_3140424828)
[Inochi2D](https://inochi2d.com) | [On Generative AI](https://github.com/Inochi2D/inochi2d/blob/main/CONTRIBUTING.md#on-generative-ai) | No | - | - | - | -
[Iocaine](https://iocaine.madhouse-project.org) | [Contributing to the project](https://git.madhouse-project.org/iocaine/iocaine/src/branch/main/CONTRIBUTING.md) | No | - | - | - | -
...
[Jqwik](https://jqwik.net) | [Contributing](https://github.com/jqwik-team/jqwik/blob/main/CONTRIBUTING.md) | No | - | Yes | - | -
[jsoup](https://jsoup.org) | [Use of AI](https://github.com/jhy/jsoup/blob/master/.github/CONTRIBUTING.md#use-of-ai) | No | - | - | - | -
...
[libxml2](https://gitlab.gnome.org/GNOME/libxml2) | [Strict No LLM / No AI Policy](https://gitlab.gnome.org/GNOME/libxml2#strict-no-llm--no-ai-policy) | No | - | - | - | -
[Lighthouse](https://www.writelighthouse.com) | [A quick "Constitution" for Lighthouse](https://github.com/team-crystalline/Lighthouse/tree/master?tab=readme-ov-file#a-quick-constitution-for-lighthouse) | No | - | - | - | -
...
[Lobsters](https://github.com/lobsters/lobsters) | [Getting oriented](https://github.com/lobsters/lobsters/blob/main/CONTRIBUTING.md#getting-oriented) | No | - | Yes | - | -
[LÖVE](https://love2d.org/) | [Contributing](https://github.com/love2d/love#contributing) | No | - | - | - |
[Makko](https://makko.starlightnet.work) | [Contributor Policy Agreement](https://forge.starlightnet.work/Team/Meta/src/branch/master/Contribution-Policy-Agreement.md) | No | - | - | - | -
...
[mGBA](https://mgba.io) | [Contribution Guidelines](https://github.com/mgba-emu/mgba/blob/master/CONTRIBUTING.md#filing-pull-requests) | No | - | - | - | -
...
[Migraine Log](https://migrainelog.zerodogg.org/en) | [Use of Generative AI](https://gitlab.com/mglog/org.zerodogg.migraineLog/-/blob/main/CONTRIBUTING.md?ref_type=heads#use-of-generative-ai) | No | - | Yes | - | -
[Mikan](https://codeberg.org/1lab/mikan) | [Contributing](https://codeberg.org/1lab/mikan/src/branch/main/CONTRIBUTING.md) | No | - | - | - | -
[MirBSD](https://mbsd.evolvis.org/subprj.htm) | [More on the so-called “AI” craze](https://mbsd.evolvis.org/permalinks/wlog2021_e20240726.htm#e20240726_wlog2021) | No | - | Yes | - | -
...
[Musl](https://musl.libc.org) | [Re: Proposed "AI" policies](https://www.openwall.com/lists/musl/2026/03/01/4) | No | - | Yes | - | Threats reading an AI generated solution as being potentially tainted by proprietary code.
...
[Pallets](https://palletsprojects.com/) | [LLM and AI Policy](https://palletsprojects.com/contributing/llm-ai) | No | - | - | - | Applies to Flask, Jinja, Click, etc. "This policy focuses on trust and quality, but there are numerous other issues with the social, ethical, resource, and environmental impacts of LLM development and use."
...
[pkgconf](https://github.com/pkgconf/pkgconf/tree/master) | [Instructions for agentic systems](https://github.com/pkgconf/pkgconf/blob/master/CONTRIBUTING.md#instructions-for-agentic-systems) | No | - | - | - | Instructs agents to stop.
[Poezio](https://poez.io) | [Use of Generative AI](https://codeberg.org/poezio/poezio#use-of-generative-ai) | No | - | Yes | - | -
...
[Polyphony](https://codeberg.org/polyphony) | [Polyphony Contributor Code of Conduct](https://codeberg.org/polyphony/.profile/src/branch/main/CODE_OF_CONDUCT.md) | No | - | Yes* | - | "The training data used for these models is largely obtained without the consent of artists, denying them their right of control over their work and any sort of financial compensation."
...
[Rust](https://rust-lang.org/) | [LLM Usage Policy](https://forge.rust-lang.org/policies/llm-usage.html) | Yes | Yes | No | Yes | [Announcement (blog post)](https://blog.rust-lang.org/inside-rust/2026/08/05/rust-langrust-is-adopting-an-llm-policy/)
[Schism Tracker](https://schismtracker.org) | [AGENTS.md](https://github.com/schismtracker/schismtracker/blob/master/AGENTS.md) | No | - | Yes | - | "Code generated by such LLMs may be based upon code under a license that is incompatible with the GPLv2." |
...
[snac](https://codeberg.org/grunfink/snac2) | [Contributing to snac](https://codeberg.org/grunfink/snac2/src/branch/master/CONTRIBUTING.md) | No | - | - | - | -
...
[Veloren](https://veloren.net) | [Contributing](https://gitlab.com/veloren/veloren/-/blob/master/CONTRIBUTING.md?ref_type=heads#do-not-commit-tainted-content-to-the-repository) | No | - | Yes | - | "Content generated by large language models \[...\], is presumed to be tainted content, and must not be committed."
[Vim Classic](https://vim-classic.org/) | [Free of generative AI](https://sr.ht/~sircmpwn/vim-classic/) | No | - | - | - | - |
[Wafrn](https://wafrn.net) | [AI Contributions Policy](https://codeberg.org/wafrn/wafrn/src/branch/main/CONTRIBUTING.md) | No | - | - | - | -
...
[x86css](https://lyra.horse/x86css) | [What ai/model/llm do you use?](https://lyra.horse/x86css/#ai) | No | - | - | - | "I do not use ai. I don't think you can build a project like this with an llm."
...
[XScreenSaver](https://www.jwz.org/xscreensaver) | [FAQ: 25.](https://www.jwz.org/xscreensaver/faq.html#writing-savers) | No | - | - | - | -
[yt-dlp](https://github.com/yt-dlp/yt-dlp/tree/master) | [AUTOMATED CONTRIBUTIONS (AI / LLM) POLICY](https://github.com/yt-dlp/yt-dlp/blob/master/CONTRIBUTING.md#automated-contributions-ai--llm-policy) | No | - | Yes | - | "AI-generated code conflicts with this project's license (Unlicense), since you cannot truly release code into the public domain if you didn't author it yourself."
...
[Ziglings](https://codeberg.org/ziglings/exercises) | [AI-Generated Content](https://codeberg.org/ziglings/exercises/src/branch/main/CONTRIBUTING.md#ai-generated-content) | No | - | - | - | AI tools are allowed to polish English only
